...
<html lang="en" class="no-js">
    ...
    <body id="body" data-spy="scroll" data-target=".header">
                ...
                <div class="row">
                    <div class="col-sm-6 sm-margin-b-60">
                        <div class="margin-b-30">
                            <h1 class="promo-block-title">Utsav <br/> Luitel</h1>
                            <p class="promo-block-text">Java Learner/Programmer</p>
                        </div>
                        <ul class="list-inline">
                            <li><a href="https://www.facebook.com/utsav.luitel?ref=bookmarks" class="social-icons" target="_blank"><i class="icon-social-facebook"></i></a></li>
                    ...
                    <div class="col-sm-6">
                        <div class="promo-block-img-wrap">
                            <img class="promo-block-img img-responsive" src="${pageContext.servletContext.contextPath}/img/mockup/utsav.jpg" align="Avatar">
                        </div>
                    </div>
                </div>
                <!--// end row -->
                    ...
                    <div class="col-sm-7">
                        <div class="section-seperator margin-b-50">
                            <div class="margin-b-50">
                                <div class="margin-b-30">
                                    <h2>About Me</h2>
                                    <p>I am Utsav Luitel.I am Student of Information Technology.I love coding.I am Studing in Bachelor's level at St.Xavier's, Nepal</p>
                                    <p>I have Java Student.I have been learning for more than a year.I used to Built web page using java frameworks. </p>
                                </div>
		<a href="${pageContext.servletContext.contextPath}/vendor/cv.docx" class="btn-theme btn-theme-md btn-default-bg text-uppercase" download>Download My CV </a>
                    ...
                    <div class="row row-space-2 margin-b-4">
                        <div class="col-md-4 col-sm-6 md-margin-b-4">
                            <div class="service" data-height="height">
                                ...
                                <a href="https://github.com/mautsav01/swing-Earthquake" class="content-wrapper-link" target="_blank"></a>    
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6 md-margin-b-4">
        ...
        of any person and display according to their unique email address</p>
                                ...
                                <a href="https://github.com/mautsav01/CVFINAl" class="content-wrapper-link" target="_blank"></a>    
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6 sm-margin-b-4">
                            <div class="service" data-height="height">
                                ...
                                <a href=" https://github.com/mautsav01/projectfinal.git" class="content-wrapper-link" target="_blank"></a>    
                            </div>
                        </div>
                        <!--// end row -->
                </div>

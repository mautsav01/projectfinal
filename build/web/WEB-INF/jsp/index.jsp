...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/assets/et-line-font-plugin/style.css">
  ...
  <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/assets/dropdown/css/style.css">
...
<section class="mbr-section article mbr-parallax-background mbr-after-navbar" id="msg-box8-1" style="background-image: url(assets/images/desert.jpg); padding-top: 120px; padding-bottom: 120px;">
...
<section class="mbr-footer mbr-section mbr-section-md-padding" id="contacts3-5" style="background-color: rgb(46, 46, 46); padding-top: 90px; padding-bottom: 90px;">
            ...
            <div class="col-xs-12 col-md-6 col-lg-3" data-form-type="formoid">
                ...
                <form action="https://mobirise.com/" method="post" data-form-title="MESSAGE">
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="contacts3-5-email">Email<span class="form-asterisk">*</span></label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="contacts3-5-message">Message</label>
  ...
  <script src="${pageContext.servletContext.contextPath}/assets/dropdown/js/script.min.js"></script>
  <script src="${pageContext.servletContext.contextPath}/assets/touch-swipe/jquery.touch-swipe.min.js"></script>
  <script src="${pageContext.servletContext.contextPath}/assets/viewport-checker/jquery.viewportchecker.js"></script>
  <script src="${pageContext.servletContext.contextPath}/assets/jarallax/jarallax.js"></script>

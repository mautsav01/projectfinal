...
.bgimg {
    ...
    background-image: url("${pageContext.servletContext.contextPath}/assets/images/coffeehouse.jpg");
    min-height: 75%;
}
.menu {
    display: none;
...
<div class="w3-container" id="about">
  <div class="w3-content" style="max-width:700px">
    ...
    <img src="${pageContext.servletContext.contextPath}/assets/images/coffeeshop.jpg" style="width:100%;max-width:1000px" class="w3-margin-top">
...
<div class="w3-container" id="menu">
  <div class="w3-content" style="max-width:700px">
    ...
    <img src="${pageContext.servletContext.contextPath}/assets/images/coffeehouse2.jpg" style="width:100%;max-width:1000px;margin-top:32px;">
  </div>
</div>
